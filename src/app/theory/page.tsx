...
const STATIC_TESTS: Record<string, Record<string, any[]>> = {
  "Қазақстан тарихы": {
    ...
    "Қола дәуірі": [
      ...
      { id: "15", text: "Қола дәуірінде қоғамдық қатынаста маңызды өзгеріс:", options: ["Теңдіктің күшеюі", "Мүлік теңсіздігінің шығуы", "Мемлекеттың толық жойылуы", "Жазудың таралуы"], correctAnswer: "B" },
...
function SubjectCard({ subject }: { subject: string }) {
  ...
  const specialTopics = ["Тас дәуірі", "Қола дәуірі", "Ерте темір дәуірі"];
