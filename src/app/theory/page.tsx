...
const STATIC_TESTS: Record<string, Record<string, any[]>> = {
  "Қазақстан тарихы": {
    "Тас дәуірі": [
      ...
      { id: "29", text: "Алғашқы адамдардың қабірге зат қоса жерлеуі нені көрсетеді?", options: ["Сауданың дамуын", "О дүниеге сенім Cochran болғанын", "Мемлекеттің құрылғанын", "Жазудың пайда болғанын"], correctAnswer: "B" },
      ...
      { id: "43", text: "Тас дәуіріндегі ең еңбек бөлінісіның қарапайым түрі:", options: ["Саудагерлер мен шенеуніктерге бөліну", "Ерлер аң аулап, әйелдер терімшілікпен айналысуы", "Қала мен ауылға бөліну", "Әскер мен діни топқа бөліну"], correctAnswer: "B" },
    ...
    "Ерте темір дәуірі": [
      ...
      { id: "6", text: "Ерте темір дәуірінде тайпалардың қоныс аударып жүруінің басты себебі:", options: ["Кен өндіру", "Мала жайылым іздеу", "Қала салу", "Кеме жасау"], correctAnswer: "B" },
      ...
      { id: "19", text: "Ерте темір дәуіріндегі өнерге тән басты стиль:", options: ["Геометриялық стиль ғана", "Аң стилі", "Қала стилі", "Роман стилі"], correctAnswer: "B" },
      ...
      { id: "26", text: "Ерте темір дәуірінде шаруашылық пен тұрмысқа үлкен өзгеріс әкелген жануар:", options: ["Пілі", "Жылқы", "Ит", "Мысық"], correctAnswer: "B" },
      ...
      { id: "39", text: "Тасмола мәдениетінің ескерткіштері қай тайпалармен байланыстырылып қарастырылады?", options: ["Исседондар, арриппейлер, аримаспылар", "Қаңлылар, үйсіндер, ғұндар", "Түріктер, қарлұқтар, қыпшақтар", "Наймандар, керейіттер, жалайырлар"], correctAnswer: "A" },
      ...
      { id: "41", text: "Ерте темір дәуіріндегі наным-сенімдерге тән ұғым:", options: ["Күнге, отқа, ата-баба рухына табыну", "Тек ғылыми көзқарас", "Діннің мүлде болмауы", "Тек жазбаша заңға сену"], correctAnswer: "A" },
...
const UBT_TOPICS: Record<string, { topics: string[], description: string }> = {
  ...
  "Математика": {
    ...
    topics: [
      ...
      "Алғашқы функция", "Интегралдың бастапқы түсініктері", "Векторлар", "Координаталар әдісі",
...
function SubjectCard({ subject }: { subject: string }) {
  ...
  const hasSpecialTest = subject === "Қазақстан тарихы" && 
    (ubtInfo.topics.includes("Тас дәуірі") || ubtInfo.topics.includes("Ерте темір дәуірі"));
